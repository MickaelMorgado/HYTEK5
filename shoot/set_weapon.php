<?php 
	...
	mysqli_query($link,"UPDATE shooters_myweapon INNER JOIN users ON shooters_myweapon.id_session=users.id_session SET src = '$weaponappearance' , sound_fire  = '$weaponsound' , sound_reload  = '$weaponreloadsound' WHERE users.id_session = $_SESSION[id_session];");
